...
<script type="text/javascript" src="/3_12/weibo/Public/Home/js/base.js"></script>
    ...
    <link rel="stylesheet" href="/3_12/weibo/Public/Home/css/space.css">
...
<body>
    ...
    <dt><img src="/3_12/weibo/<?php echo ($face); ?>" alt=""></dt>
   
    <dd class="username"><?php echo ($username); ?></dd>
    <dd class="info">个人简介：<?php echo ($intro); ?></dd>
    </dl>
    </div>
    </div>
